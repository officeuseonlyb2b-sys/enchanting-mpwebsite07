  ...
  return (
    <section className="relative w-full overflow-hidden py-4 bg-[#f8fafc]">
      ...
      <div className="relative flex flex-col md:flex-row items-stretch md:items-center overflow-hidden border-y border-white/60 bg-white/95 backdrop-blur-xl shadow-[0_10px_40px_rgba(0,0,0,0.06)]">
        {/* LEFT CONTENT - Centered on mobile, row on desktop */}
        <div className="relative z-20 flex flex-col md:flex-row items-center justify-center md:justify-start gap-3 md:gap-5 px-5 md:px-8 lg:px-12 py-4 md:py-5 bg-white md:border-r border-b md:border-b-0 border-gray-200/60 w-full md:w-auto">
          ...
          <div className="min-w-0 text-center md:text-left">
            ...
            <h2 className="text-[22px] md:text-[30px] lg:text-[42px] font-bold text-gray-900 leading-[0.95] tracking-[-1px] md:tracking-[-1.5px]">
              Brands That
